<?php
/**
 * Description of OApi_Interface_Pptp_Server
 *
 * TOC :
 *	PPTP Server
 *	  get_all_pptp_server
...
class OInterfacePptpServer {
	 ...
	 * @return type array
	 */
	public function set_pptp_server($param) {
		$this->_conn->comm("/interface/pptp-server/set", $param);
		$this->_conn->disconnect();
		return array('success'=>1);
	}
